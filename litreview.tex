...
In \textbf{Appendix~\ref{app:bia_data_classes}}, the classes and characteristics of data, given by Chen et
...
identifiable information, confidential information, etc. The sentivity of the data determines the requirements relating
...
\newpage
\section{BI\&A data classes} \label{app:bia_data_classes}

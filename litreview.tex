...
with their own characteristics and are often suitable for only certain types of processing. Furthermore, particular
types of data are often only found in particular applications or use cases of big data processing.
...
% section conclusion_and_discussion (end)
